...
$(TYPEDEF)
"""
struct Gent <: AbstractHyperelasticity
end
...
$(TYPEDSIGNATURES)
"""
function helmholtz_free_energy(::Gent, props, ∇u, θ)
    # unpack properties
...
function pk1_stress(::Gent, props, ∇u, θ)
    # unpack properties
    κ, μ, Jm = props[1], props[2], props[3]
...
function material_tangent(::Gent, props, ∇u, θ)
    κ, μ, Jm = props[1], props[2], props[3]
